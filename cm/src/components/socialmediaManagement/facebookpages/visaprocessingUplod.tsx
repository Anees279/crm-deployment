...
const VoxdigifyUpload: React.FC = () => {
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post('https://crm-deployment-five.vercel.app/api/visaprocessingpost/posts/media', formData, {
        headers: {
  ...
  return (
    <div className="flex flex-col items-center p-4">
      <h1 className="text-2xl font-bold mb-4 text-center">Upload Media Files with Post Details in Visa Processing Service UAE
      </h1>
...
export default VoxdigifyUpload;
