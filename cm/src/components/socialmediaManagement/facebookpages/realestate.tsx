...
import RealestateUpload from './realestateupload';
...
const Realestate: React.FC = () => {
  ...
  useEffect(() => {
    axios.get('https://crm-deployment-five.vercel.app/api/realestate/posts')
      .then(response => {
    ...
    axios.get('https://crm-deployment-five.vercel.app/api/realestate/followers')
    ...
    axios.get('https://crm-deployment-five.vercel.app/api/realestate/getPageAnalytics')
  ...
  const fetchLikes = async (postId: string) => {
    try {
      const response = await axios.get(`https://crm-deployment-five.vercel.app/api/realestate/posts/${postId}/likes`);
  ...
  const fetchComments = async (postId: string) => {
    try {
      const response = await axios.get(`https://crm-deployment-five.vercel.app/api/realestate/posts/${postId}/comments`);
      return response.data.data.length;
    } catch (error) {
