...
const RoleForm: React.FC<RoleFormProps> = ({ userId, currentRole, onSave }) => {
  ...
  const fetchUserRole = async (userId: string) => {
    try {
      ...
      const response = await axios.get(`https://crm-deployment-five.vercel.app/auth/profile/role/${userId}`, {
        headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await axios.delete(`https://crm-deployment-five.vercel.app/auth/profile/role/${userId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      await axios.put(
        `https://crm-deployment-five.vercel.app/auth/profile/role`,
        {
